...
public:
    ...
    int listLenght = 0;
    /**
     * @brief Constructor de la clase de lista de referencias
     */
    ReferenceList();
    /**
     * @brief Agrega una referencia a la lista
     * @param lvl_from entero que se refiere al nivel proveniente
     */
    void add(int lvl_from);
    /**
     * @brief Actualiza un nodo referencia al eliminar un nivel
     * @param lvlDel nivel eliminado
     */
    void update(int lvlDel);
    /**
     * @brief Devuelve las referencias que se han contado hasta el momento
