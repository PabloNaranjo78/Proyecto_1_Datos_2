...
/**
 * @brief Clase para almacenar y procesar los datos de los tipos generados por medio de structs
 */
using namespace std;
class StructType {
public:
    ...
    StructType();
    /**
     * @brief Agrega un tipo a la lista
     * @param ident identificador del tipo
     */
    void addType(string ident);
    /**
     * @brief Revisa si un identificador se encuentra en lista de structs
    ...
    /**
     * @brief Agrega atributos a un struct
    ...
    /**
     * @brief Crea una instancia de un struct previamente definido
    ...
    /**
     * @brief Muestra los valores relacionados a un struct especifico
