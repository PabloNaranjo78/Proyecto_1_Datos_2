...
\DoxyCodeLine{3179             \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be number, but is "{}} + std::string(j.type\_name())));}
\DoxyCodeLine{3180     \}}
\DoxyCodeLine{3181 \}}
...
\DoxyCodeLine{3109 \{}
\DoxyCodeLine{3110     \textcolor{keywordflow}{if} (\mbox{\hyperlink{json_8hpp_a8df7de76ab3c9445f46f6994ec205bcd}{JSON\_HEDLEY\_UNLIKELY}}(not j.is\_array()))}
\DoxyCodeLine{3111     \{}
\DoxyCodeLine{3112         \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be array, but is "{}} +}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{3122 \{}
\DoxyCodeLine{3123     \textcolor{keywordflow}{if} (\mbox{\hyperlink{json_8hpp_a8df7de76ab3c9445f46f6994ec205bcd}{JSON\_HEDLEY\_UNLIKELY}}(not j.is\_object()))}
\DoxyCodeLine{3124     \{}
\DoxyCodeLine{3125         \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be object, but is "{}} + std::string(j.type\_name())));}
\DoxyCodeLine{3126     \}}
\DoxyCodeLine{3127 }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{2965 \{}
\DoxyCodeLine{2966     \textcolor{keywordflow}{if} (\mbox{\hyperlink{json_8hpp_a8df7de76ab3c9445f46f6994ec205bcd}{JSON\_HEDLEY\_UNLIKELY}}(not j.is\_string()))}
\DoxyCodeLine{2967     \{}
\DoxyCodeLine{2968         \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be string, but is "{}} + std::string(j.type\_name())));}
\DoxyCodeLine{2969     \}}
\DoxyCodeLine{2970 }
...
\begin{DoxyCode}{0}
\DoxyCodeLine{3005 \{}
\DoxyCodeLine{3006     \textcolor{keywordflow}{if} (\mbox{\hyperlink{json_8hpp_a8df7de76ab3c9445f46f6994ec205bcd}{JSON\_HEDLEY\_UNLIKELY}}(not j.is\_array()))}
\DoxyCodeLine{3007     \{}
\DoxyCodeLine{3008         \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be array, but is "{}} + std::string(j.type\_name())));}
\DoxyCodeLine{3009     \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{3205 \{}
\DoxyCodeLine{3206     \textcolor{keywordflow}{if} (\mbox{\hyperlink{json_8hpp_a8df7de76ab3c9445f46f6994ec205bcd}{JSON\_HEDLEY\_UNLIKELY}}(not j.is\_array()))}
\DoxyCodeLine{3207     \{}
\DoxyCodeLine{3208         \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be array, but is "{}} + std::string(j.type\_name())));}
\DoxyCodeLine{3209     \}}
\DoxyCodeLine{3210     m.clear();}
\DoxyCodeLine{3211     \textcolor{keywordflow}{for} (\textcolor{keyword}{const} \textcolor{keyword}{auto}\& p : j)}
\DoxyCodeLine{3212     \{}
\DoxyCodeLine{3213         \textcolor{keywordflow}{if} (\mbox{\hyperlink{json_8hpp_a8df7de76ab3c9445f46f6994ec205bcd}{JSON\_HEDLEY\_UNLIKELY}}(not p.is\_array()))}
\DoxyCodeLine{3214         \{}
\DoxyCodeLine{3215             \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be array, but is "{}} + std::string(p.type\_name())));}
\DoxyCodeLine{3216         \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{3225 \{}
\DoxyCodeLine{3226     \textcolor{keywordflow}{if} (\mbox{\hyperlink{json_8hpp_a8df7de76ab3c9445f46f6994ec205bcd}{JSON\_HEDLEY\_UNLIKELY}}(not j.is\_array()))}
\DoxyCodeLine{3227     \{}
\DoxyCodeLine{3228         \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be array, but is "{}} + std::string(j.type\_name())));}
\DoxyCodeLine{3229     \}}
\DoxyCodeLine{3230     m.clear();}
\DoxyCodeLine{3231     \textcolor{keywordflow}{for} (\textcolor{keyword}{const} \textcolor{keyword}{auto}\& p : j)}
\DoxyCodeLine{3232     \{}
\DoxyCodeLine{3233         \textcolor{keywordflow}{if} (\mbox{\hyperlink{json_8hpp_a8df7de76ab3c9445f46f6994ec205bcd}{JSON\_HEDLEY\_UNLIKELY}}(not p.is\_array()))}
\DoxyCodeLine{3234         \{}
\DoxyCodeLine{3235             \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be array, but is "{}} + std::string(p.type\_name())));}
\DoxyCodeLine{3236         \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{3022 \{}
\DoxyCodeLine{3023     \textcolor{keywordflow}{if} (\mbox{\hyperlink{json_8hpp_a8df7de76ab3c9445f46f6994ec205bcd}{JSON\_HEDLEY\_UNLIKELY}}(not j.is\_array()))}
\DoxyCodeLine{3024     \{}
\DoxyCodeLine{3025         \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be array, but is "{}} + std::string(j.type\_name())));}
\DoxyCodeLine{3026     \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{2939 \{}
\DoxyCodeLine{2940     \textcolor{keywordflow}{if} (\mbox{\hyperlink{json_8hpp_a8df7de76ab3c9445f46f6994ec205bcd}{JSON\_HEDLEY\_UNLIKELY}}(not j.is\_boolean()))}
\DoxyCodeLine{2941     \{}
\DoxyCodeLine{2942         \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be boolean, but is "{}} + std::string(j.type\_name())));}
\DoxyCodeLine{2943     \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{2949 \{}
\DoxyCodeLine{2950     \textcolor{keywordflow}{if} (\mbox{\hyperlink{json_8hpp_a8df7de76ab3c9445f46f6994ec205bcd}{JSON\_HEDLEY\_UNLIKELY}}(not j.is\_string()))}
\DoxyCodeLine{2951     \{}
\DoxyCodeLine{2952         \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be string, but is "{}} + std::string(j.type\_name())));}
\DoxyCodeLine{2953     \}}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{2899 \{}
\DoxyCodeLine{2900     \textcolor{keywordflow}{if} (\mbox{\hyperlink{json_8hpp_a8df7de76ab3c9445f46f6994ec205bcd}{JSON\_HEDLEY\_UNLIKELY}}(not j.is\_null()))}
\DoxyCodeLine{2901     \{}
\DoxyCodeLine{2902         \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be null, but is "{}} + std::string(j.type\_name())));}
\DoxyCodeLine{2903     \}}
...
\DoxyCodeLine{2933             \mbox{\hyperlink{json_8hpp_a6c274f6db2e65c1b66c7d41b06ad690f}{JSON\_THROW}}(type\_error::create(302, \textcolor{stringliteral}{"{}type must be number, but is "{}} + std::string(j.type\_name())));}
\DoxyCodeLine{2934     \}}
\DoxyCodeLine{2935 \}}
...
\DoxyCodeLine{13716     \{}
\DoxyCodeLine{13717         value = -\/value;}
...
\DoxyCodeLine{13750 }
\DoxyCodeLine{13751     \textcolor{keywordflow}{return} \mbox{\hyperlink{namespacenlohmann_1_1detail_1_1dtoa__impl_ab441f2761e33839ca48bc2225e14a2a9}{dtoa\_impl::format\_buffer}}(first, len, decimal\_exponent, kMinExp, kMaxExp);}
\DoxyCodeLine{13752 \}}
